...
#define NL_MINOR_VERSION 4
#define NL_VERSION_STRING "HawkNL 1.4 beta 4"
...
/* some helpful macros for endian conversion */

#ifdef NL_LITTLE_ENDIAN
#define nlSwaps(x) (NLushort)(((((NLushort)x) & 0x00ff) << 8) | ((((NLushort)x) & 0xff00) >> 8))

#define nlSwapl(x) (NLulong)(((((NLulong)x) & 0x000000ff) << 24) | ((((NLulong)x) & 0x0000ff00) << 8) | ((((NLulong)x) & 0x00ff0000) >> 8) | ((((NLulong)x) & 0xff000000) >> 24))

NL_INLINE NLfloat nlSwapf(NLfloat f)
{
...
NL_INLINE NLdouble nlSwapd(NLdouble d)
{
...
#define nl_writeShort(x, y, z)     {*((NLushort *)((NLbyte *)&x[y])) = nlSwaps(z); y += 2;}
#define nl_readShort(x, y, z)      {z = nlSwaps(*(NLushort *)((NLbyte *)&x[y])); y += 2;}
