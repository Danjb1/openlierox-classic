...
void Menu_MapEd_New(void)
{
	...
	while(!kb->KeyUp[SDLK_ESCAPE] && !quitloop) {
		...
		tLX->cFont.DrawCentre(tMenu->bmpScreen, 320, 175, 0xffff, "Level details");
		tLX->cFont.Draw(tMenu->bmpScreen, 220, 202, 0xffff, "Width");
		tLX->cFont.Draw(tMenu->bmpScreen, 220, 232, 0xffff, "Height");
		tLX->cFont.Draw(tMenu->bmpScreen, 220, 262, 0xffff, "Theme");
...
void Menu_MapEd_LoadSave(int save)
{
	...
	while(!kb->KeyUp[SDLK_ESCAPE] && !quitloop) {
		...
		tLX->cFont.DrawCentre(tMenu->bmpScreen, 320, 155, 0xffff, save ? "Save" : "Load");
		tLX->cFont.Draw(tMenu->bmpScreen, 180,288,0xffff,"Level name");
