...
void Menu_MainFrame(void)
{
	...
	tLX->cFont.Draw(tMenu->bmpScreen, 395, 430, MakeColour(96,96,96), "Liero Xtreme v%.2fb",LX_VERSION);
	tLX->cFont.Draw(tMenu->bmpScreen, 395, 443, MakeColour(96,96,96), "By Auxiliary Software 2002-2003");
