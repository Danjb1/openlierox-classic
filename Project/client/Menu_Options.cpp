...
int Menu_OptionsInitialize(void)
{
	...
	cOpt_Game.Add( new CCheckbox(tLXOptions->iShadows),     Shadows, 180, 180, 17,17);
	cOpt_Game.Add( new CLabel("Particles",0xffff),          Static, 40, 210, 0,0);
	cOpt_Game.Add( new CCheckbox(tLXOptions->iParticles),   Particles, 180, 210, 17,17);
	cOpt_Game.Add( new CLabel("Classic Rope throw",0xffff), Static, 40, 240, 0,0);
	cOpt_Game.Add( new CCheckbox(tLXOptions->iOldSkoolRope),OldSkoolRope, 180, 240, 17,17);
